...
app.post('/api/auth/register', (req, res) => {
    ...
    db.users[loginId] = { loginId, name, library: null, playlist: null, createdAt: new Date().toISOString() };
    writeUsersDb(db);
    res.json({ loginId, name });
});
...
app.post('/api/auth/login', (req, res) => {
    ...
    res.json({ loginId: user.loginId, name: user.name, library: user.library, playlist: user.playlist });
});
